...
function setDinoLose() {
  dino.src = "static/dinogame/assets/dino-lose.png";
}

function handleRun(delta, speedScale) {
  if (isJumping) {
    dino.src = "static/dinogame/assets/dino-stationary.png";
    return;
  }

  if (currentFrameTime >= FRAME_TIME) {
    dinoFrame = (dinoFrame + 1) % DINO_FRAME_COUNT;
    dino.src = "static/dinogame/assets/dino-run-0.png";
    if (dinoFrame == 1) {
      dino.src = "static/dinogame/assets/dino-run-1.png";
    }
    // dino.src = "{% static 'dinogame/assets/dino-run-1.png' %}"; /* switch between images to simulate movement */
...
function createCactus() {
  ...
  cactus.src = "static/dinogame/assets/cactus.png";
